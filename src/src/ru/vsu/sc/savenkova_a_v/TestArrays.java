...
public class TestArrays {
    public TestCase[] getTestArrays() {
        ...
        TestCase oddNumbersOnly = new TestCase(new int[]{3, 1, 51, 13, 5, 75}, 0);
        TestCase onlyZeros = new TestCase(new int[]{0, 0, 0, 0, 0, 0}, 0);
        TestCase indexLastEvenNumberMoreIndexLastOddNumber = new TestCase(new int[]{3, 5, 6, 7, 12, 10, 2}, 22);
        TestCase indexLastEvenNumberLessIndexLastOddNumber = new TestCase(new int[]{2, 4, 5, 28, 31, 3, 5}, 34);
        TestCase sumIsZero = new TestCase(new int[]{2, 0, 0, 0, 0, 3}, 0);
        TestCase emptyArray = new TestCase(new int[]{}, 0);
        TestCase arrayWithZeros = new TestCase(new int[]{23, 0, 32, 5, 0, 6, 8}, 6);
